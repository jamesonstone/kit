...
func subagentPromptSuffix() string {
	return strings.Join([]string{
		...
		"- Use one lane for trivial, tightly coupled, ambiguous, or high-overlap work. Otherwise run at most 3 independent lanes (hard ceiling 4) and serialize shared files or interfaces.",
