...
func subagentPromptSuffix() string {
	return strings.Join([]string{
		...
		"- After nontrivial implementation, use fresh independent read-only verification by a verifier when supported. Otherwise perform a distinct read-only supervisor self-review and state that verification was not independent.",
