...
func TestAgentTeamOrchestrationRegistryRulesetIsCapabilityAware(t *testing.T) {
	...
	for _, check := range []string{
		...
		"`PR_READY` never implies standing merge authority or `MERGE_READY`",
		"explicit bounded standing-authority selector may bind later in-scope PRs and refreshed heads",
