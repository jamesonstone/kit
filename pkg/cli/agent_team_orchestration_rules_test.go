...
func TestAgentTeamOrchestrationRegistryRulesetIsCapabilityAware(t *testing.T) {
	...
	for _, check := range []string{
		...
		"`PR_READY` never implies `MERGE_AUTHORIZED`",
		"direct user request or accepted bounded merge plan for the exact current pull-request set",
		...
		"It never implies merge authorization for that separate pull request",
