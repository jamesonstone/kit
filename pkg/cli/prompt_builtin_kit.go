...
func builtInKitPromptSource() promptlib.Source {
	return promptlib.Source{
		...
		Prompts: []promptlib.Prompt{
			...
			dynamicBuiltInPrompt("workflow", "tasks", "Regenerate the task breakdown prompt for an existing feature.", []string{promptContextActiveFeature}, renderWorkflowTasksPrompt),
