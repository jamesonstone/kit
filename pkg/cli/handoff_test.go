...
func TestProjectHandoffIncludesProgressSummaryAndStatus(t *testing.T) {
	...
	checks := []string{
		...
		"canonical front matter dependencies list current `active`, `optional`, and `stale` dependencies with exact locations",
...
func TestFeatureHandoffIncludesDocSyncInstructions(t *testing.T) {
	...
	checks := []string{
		...
		"Verify that `BRAINSTORM.md`, `SPEC.md`, and `PLAN.md` keep canonical front matter dependencies current",
