...
func managedFileDeliveryClosingInstructions() []string {
	return []string{
		...
		"Merge the worktree pull request when it is in accepted-task scope and current `MERGE_READY`, following `github-pr-merge`. Do not stop for a separate merge-consent prompt. This leftover cleanup does not invent readiness.",
