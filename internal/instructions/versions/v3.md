...
- Use the Kit-owned `git wt` workflow for lane creation, reuse, repair, removal, pruning, and migration; load `docs/references/worktrees.md` for command usage and safety.
