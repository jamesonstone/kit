...
- Optional wrappers are manual conveniences only and must preserve the same path and safety contract; load `docs/references/worktrees.md` for the complete portable workflow.
