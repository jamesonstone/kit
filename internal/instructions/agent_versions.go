...
var agentInstructionVersions = []agentInstructionVersion{
	...
	{name: "v3", path: "versions/v3.md"},
	{name: "v4", path: "versions/v4.md"},
	{name: "v5", path: "versions/v5.md"},
	{name: "v6", path: "versions/v6.md"},
	{name: "v7", path: "versions/v7.md"},
	{name: "v8", path: "versions/v8.md"},
	{name: "v9", path: "versions/v9.md"},
	{name: "v10", path: "versions/v10.md"},
	{name: "v11", path: "versions/v11.md"},
	{name: "v12", path: "versions/v12.md"},
	{name: "v13", path: "versions/v13.md"},
	{name: "v14", path: "versions/v14.md"},
	{name: "v15", path: "versions/v15.md"},
	{name: "v16", path: "versions/v16.md"},
	{name: "v17", path: "versions/v17.md"},
}
