...
- Use ` + "`rules/agent-completion-output.md`" + ` before substantial terminal completion or handoff responses to require a literal status, immediate prioritized action list, and task-specific evidence profile; answer ordinary conversational requests naturally without that structured envelope
