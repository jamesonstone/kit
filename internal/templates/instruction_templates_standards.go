...
const sharedRepositoryInstructionsStandards = `
### Phase 3: REFLECT
...
- Fix all lint and test failures before completion, including failures outside the immediate scope.
- Wait for the user's output before triaging or fixing findings they report.
...
- Update only relevant practical docs when behavior/usage changes
