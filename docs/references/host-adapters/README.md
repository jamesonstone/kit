...
- Normative topology remains in `docs/references/rules/agent-team-orchestration.md`; Codex thread lifecycle remains in `docs/references/rules/codex-thread-initialization.md`.

Files:

- `codex.md` — Codex thread operations, browser, and subagent bindings.
