...
9. **Project-Oriented Git Worktrees**
   ...
   - The explicit merged-lane sync may discard only an actual ignored repository-root `bin/` build-output directory after same-repository merged-PR and exact-head proof; manual removal and all other dirty or ignored material remain protected
