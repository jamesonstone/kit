...
references:
  ...
  - name: Workflow and guardrail docs
    type: doc
    target: docs/agents/WORKFLOWS.md, docs/agents/GUARDRAILS.md, docs/agents/TOOLING.md
    relation: uses
    read_policy: conditional
    used_for: spec-driven workflow, completion bar, front matter references rules, skills discovery rules
    status: active
  - name: RLM guide
    type: doc/skill
  ...
  - name: Human output helpers
    type: code
    target: pkg/cli/human_output.go, pkg/cli/root_help.go
    relation: implements
    read_policy: conditional
...
| Workflow and guardrail docs | doc | docs/agents/WORKFLOWS.md, docs/agents/GUARDRAILS.md, docs/agents/TOOLING.md | spec-driven workflow, completion bar, front matter references rules, skills discovery rules | active |
