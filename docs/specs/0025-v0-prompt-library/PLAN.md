...
dependencies:
  - name: "Constitution"
    ...
    used_for: "filesystem-only state, command constraints, config reference, actionable errors"
    status: "active"
  - name: "Agent routing docs"
    type: "doc"
    location: "AGENTS.md, docs/agents/README.md, docs/agents/WORKFLOWS.md, docs/agents/GUARDRAILS.md"
    used_for: "formal workflow routing, required plan content, completion bar"
    status: "active"
  - name: "RLM guide"
    type: "doc/skill"
    location: "docs/agents/RLM.md"
    used_for: "scoped prior-work and code-pattern discovery; `parallelization_mode: \"rlm\"`"
    status: "active"
  - name: "BRAINSTORM"
    type: "doc"
    location: "docs/specs/0025-v0-prompt-library/BRAINSTORM.md"
    used_for: "resolved hierarchy, CLI behavior, editor, list, and overwrite decisions"
    status: "active"
  - name: "SPEC"
    type: "doc"
    location: "docs/specs/0025-v0-prompt-library/SPEC.md"
    used_for: "fixed requirements and acceptance contract for implementation"
    status: "active"
  - name: "PLAN template"
    type: "doc"
    location: "docs/specs/0025-v0-prompt-library/PLAN.md"
    used_for: "target implementation strategy artifact"
    status: "active"
  - name: "kit map output"
    type: "command output"
    location: "kit map 0025-v0-prompt-library"
    used_for: "current phase, relationship verification, dependency baseline"
    status: "active"
  - name: "Project progress summary"
    type: "doc"
    location: "docs/PROJECT_PROGRESS_SUMMARY.md"
    used_for: "prior-feature index and current feature status"
    status: "active"
  - name: "Brainstorm-first workflow spec"
    type: "prior feature doc"
    location: "docs/specs/0004-brainstorm-first-workflow/SPEC.md"
    used_for: "editor-default free-text flow and clipboard-first workflow prompt precedent"
    status: "active"
  - name: "Dispatch command spec"
    type: "prior feature doc"
    location: "docs/specs/0008-dispatch-command/SPEC.md"
    used_for: "editor-backed capture and dispatch prompt provider behavior"
    status: "active"
  ...
  - name: "Command surface simplification spec"
    ...
    used_for: "root help grouping and prompt-utility placement"
    status: "active"
  - name: "Typed prompt IR spec"
    type: "prior feature doc"
    location: "docs/specs/0022-typed-prompt-ir/SPEC.md"
    used_for: "structured prompt builders and prompt-producing command inventory"
    status: "active"
  - name: "Karabiner prompt script"
    type: "external script"
    location: "/Users/jamesonstone/.config/karabiner/scripts/insert_prompt.sh"
    used_for: "source payloads for `coding-agent` built-ins; shell automation excluded"
    status: "active"
  - name: "Project config"
    type: "config"
    location: ".kit.yaml"
    used_for: "local prompt storage and schema extension point"
    status: "active"
  - name: "Global Kit config"
    type: "config"
    location: "~/.config/kit/.kit.yaml"
    used_for: "global prompt storage target; created or populated by `kit init`, and may still be absent before init or first global save"
    status: "active"
  - name: "Config package"
    type: "code"
    location: "internal/config/config.go"
    used_for: "config schema, strict and optional project discovery, save/load helpers"
    status: "active"
  - name: "Prompt output helpers"
    type: "code"
    location: "pkg/cli/prompt_output.go, pkg/cli/clipboard.go, pkg/cli/output_test.go"
    used_for: "clipboard behavior, raw output flags, copy failure behavior"
    status: "active"
  - name: "Editor helpers"
    type: "code"
    location: "pkg/cli/editor_input.go, pkg/cli/editor_input_test.go"
    used_for: "vim-compatible prompt entry and missing-context capture"
    status: "active"
  - name: "Human output and selectors"
    type: "code"
    location: "pkg/cli/human_output.go, pkg/cli/spec_selection.go"
    used_for: "numbered selection UI and terminal-readable presentation"
    status: "active"
  - name: "Root help"
    type: "code"
    location: "pkg/cli/root_help.go, pkg/cli/root_help_test.go"
    used_for: "visible command grouping for `prompt` and `set`"
    status: "active"
  - name: "Prompt IR"
    type: "code"
    location: "internal/promptdoc/doc.go, pkg/cli/prompt_ir_helpers.go"
    used_for: "structured prompt construction for built-in adapters"
    status: "active"
  - name: "Existing prompt builders"
    type: "code"
    location: "pkg/cli/*_prompt.go, pkg/cli/spec_output.go, pkg/cli/plan.go, pkg/cli/tasks.go, pkg/cli/implement.go, pkg/cli/reflect.go, pkg/cli/resume.go, pkg/cli/handoff.go, pkg/cli/summarize.go, pkg/cli/code_review.go, pkg/cli/skill.go, pkg/cli/init.go"
    used_for: "built-in prompt providers without stale duplication"
    status: "active"
  - name: "Prompt golden tests"
    type: "tests"
    location: "pkg/cli/prompt_golden_test.go, pkg/cli/testdata/*.golden"
    used_for: "regression coverage for existing built-in prompt text"
    status: "active"
  - name: "README and config references"
    type: "docs"
    location: "README.md, docs/CONSTITUTION.md, docs/specs/0000_INIT_PROJECT.md, internal/templates/templates.go"
    used_for: "user-facing command docs and generated configuration guidance"
    status: "active"
  - name: "Feature notes"
    type: "notes"
    location: "docs/notes/0025-v0-prompt-library"
    used_for: "checked optional input; no usable files beyond `.gitkeep`"
    status: "optional"
---
# PLAN
