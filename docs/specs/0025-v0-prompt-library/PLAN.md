...
references:
  ...
  - name: Agent routing docs
    type: doc
    target: AGENTS.md, docs/agents/README.md, docs/agents/WORKFLOWS.md, docs/agents/GUARDRAILS.md
    relation: informs
    read_policy: conditional
  ...
  - name: BRAINSTORM
    type: doc
    target: docs/specs/0025-v0-prompt-library/BRAINSTORM.md
    relation: uses
    read_policy: conditional
  ...
  - name: SPEC
    type: doc
    target: docs/specs/0025-v0-prompt-library/SPEC.md
    relation: verifies
  ...
  - name: Human output and selectors
    type: code
    target: pkg/cli/human_output.go, pkg/cli/spec_selection.go
    relation: implements
    read_policy: conditional
  ...
  - name: Root help
    type: code
    target: pkg/cli/root_help.go, pkg/cli/root_help_test.go
    relation: verifies
    read_policy: evidence
  ...
  - name: Prompt IR
    type: code
    target: internal/promptdoc/doc.go, pkg/cli/prompt_ir_helpers.go
    relation: implements
    read_policy: conditional
  ...
  - name: Existing prompt builders
    type: code
    target: pkg/cli/*_prompt.go, pkg/cli/spec_output.go, pkg/cli/plan.go, pkg/cli/tasks.go, pkg/cli/implement.go, pkg/cli/reflect.go, pkg/cli/resume.go, pkg/cli/handoff.go, pkg/cli/summarize.go, pkg/cli/code_review.go, pkg/cli/skill.go, pkg/cli/init.go
    relation: implements
    read_policy: conditional
  ...
  - name: Prompt golden tests
    type: tests
    target: pkg/cli/prompt_golden_test.go, pkg/cli/testdata/*.golden
    relation: verifies
    read_policy: evidence
  ...
  - name: README and config references
    type: docs
    target: README.md, docs/CONSTITUTION.md, docs/specs/0000_INIT_PROJECT.md, internal/templates/templates.go
    relation: guides
    read_policy: conditional
