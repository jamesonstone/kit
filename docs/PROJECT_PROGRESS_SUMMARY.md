...
| 0050 | safe-worktree-workflow | `docs/specs/0050-safe-worktree-workflow` | complete | no | 2026-07-24 | Provide a portable native Git worktree policy plus an optional thin `git wt` convenience for exact navigation, bounded pull-request annotations, default writable-lane `.env` symlinks, explicit isolation, and conservative removal. |
