...
| -- | ------- | ---- | ----- | ------ | ------- | ------- |
| 0001 | refactor-plan-command | `docs/specs/0001-refactor-plan-command` | tasks | no | 2026-01-19 | (no description) |
| 0002 | cicd-goreleaser-releases | `docs/specs/0002-cicd-goreleaser-releases` | reflect | no | 2026-03-04 | - Kit lacks an automated release pipeline for cross-platf... |
| 0003 | inplace-upgrade-update | `docs/specs/0003-inplace-upgrade-update` | reflect | no | 2026-03-16 | - Kit users currently need manual update flows (for examp... |
| 0004 | brainstorm-first-workflow | `docs/specs/0004-brainstorm-first-workflow` | reflect | no | 2026-03-06 | Kit currently treats brainstorming as an external or stan... |
| 0005 | version-command | `docs/specs/0005-version-command` | reflect | no | 2026-03-06 | - Kit currently exposes version information only through ... |
| 0006 | skill-mine-command | `docs/specs/0006-skill-mine-command` | reflect | no | 2026-03-15 | - Kit has no built-in command for turning completed featu... |
| 0007 | catchup-command | `docs/specs/0007-catchup-command` | reflect | no | 2026-03-23 | - Kit has `status`, `handoff`, `summarize`, and `implemen... |
| 0008 | dispatch-command | `docs/specs/0008-dispatch-command` | reflect | no | 2026-03-27 | - Kit has prompt generators for planning, catch-up, imple... |
| 0009 | spec-skills-discovery | `docs/specs/0009-spec-skills-discovery` | reflect | no | 2026-03-29 | - Kit captures reusable skills after implementation, but ... |
| 0010 | support-command-clipboard-defaults | `docs/specs/0010-support-command-clipboard-defaults` | reflect | no | 2026-03-31 | - These three support commands still print their full pro... |
| 0011 | handoff-document-sync | `docs/specs/0011-handoff-document-sync` | reflect | no | 2026-03-31 | - `kit handoff` currently focuses on orienting a fresh ag... |
| 0012 | default-subagent-orchestration | `docs/specs/0012-default-subagent-orchestration` | reflect | no | 2026-04-03 | - Kit currently assumes a single-agent lane unless the us... |
| 0012 | implement-readiness-gate | `docs/specs/0012-implement-readiness-gate` | reflect | no | 2026-04-02 | - `kit implement` currently moves directly from document ... |
| 0013 | scaffold-agents-safe-merge | `docs/specs/0013-scaffold-agents-safe-merge` | reflect | no | 2026-04-02 | - `kit scaffold-agents` currently has binary behavior: - ... |
| 0014 | human-readable-terminal-output | `docs/specs/0014-human-readable-terminal-output` | reflect | no | 2026-04-04 | - Kit mixes plain text, sparse emoji usage, dense section... |
| 0015 | pause-remove-commands | `docs/specs/0015-pause-remove-commands` | reflect | no | 2026-04-04 | Kit currently has no lifecycle controls for work that sho... |
...
- **STATUS**: reflect
- **PAUSED**: no
- **INTENT**: - Kit currently assumes a single-agent lane unless the user explicitly adds `--subagents`. - That default underuses s...
- **APPROACH**: - [PLAN-01][SPEC-01][SPEC-02][SPEC-10] Update the shared prompt helper to make subagent guidance default-on, add `--s...
- **OPEN ITEMS**: - none
...
- **STATUS**: reflect
- **PAUSED**: no
- **INTENT**: - Kit mixes plain text, sparse emoji usage, dense section layouts, and default Cobra help formatting across its human...
- **APPROACH**: - [PLAN-01][SPEC-01][SPEC-02][SPEC-03][SPEC-04][SPEC-05] Record the approved scope and exclusions in a dedicated feat...
- **OPEN ITEMS**: - none
...
- **STATUS**: reflect
- **PAUSED**: no
- **INTENT**: Kit currently has no lifecycle controls for work that should stop without being completed or for feature directories ...
- **APPROACH**: - extend config with a small per-feature state map keyed by feature directory name - centralize pause lookups and pau...
- **OPEN ITEMS**: - none
