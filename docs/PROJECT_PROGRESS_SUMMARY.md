...
| 0052 | worktree-sync | `docs/specs/0052-worktree-sync` | reflect | no | 2026-07-26 | Add an explicit `git wt sync` command that safely reconciles the origin default branch, removes only exact merged-PR worktrees and their local branches, prunes stale metadata, and supports deterministic human/JSON dry-run reporting. |
...
- **OPEN ITEMS**: deliver the validated issue #93 implementation as a ready pull request
